document.addEventListener("DOMContentLoaded", () => {
  ...
  /* EVENTS */
  $("snakeCorruptionBtn").addEventListener("click", () => { state.snakeCorruption = false; updateAdmin(); updateBanners(); });

  $("memorySnapBtn").addEventListener("click", () => { state.memorySnap = false; updateAdmin(); updateBanners(); });
